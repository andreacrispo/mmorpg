...
public class DbTestSeeding
{
    ...
    public static void InitDb(MMORPGDbContext testDbContext)
    {
        ...
        {
      new CharacterEntity() { Id = 100, PositionX = 8, PositionY = 2, LevelValue = 1, ClassId = CharacterClass.Paladin, User = u },
      new CharacterEntity() { Id = 200, PositionX = 7, PositionY = 3, LevelValue = 1, ClassId = CharacterClass.Wizard, User = u },
      new CharacterEntity() { Id = 300, PositionX = 11, PositionY = 11, LevelValue = 1, ClassId = CharacterClass.Rogue, User = u },

      new CharacterEntity() { Id = 999, PositionX = 0, PositionY = 0, LevelValue = 1, ClassId = CharacterClass.Rogue, User = u },

       // To attack in range
      new CharacterEntity() { Id = 1001, PositionX = 5, PositionY = 5, LevelValue = 1, ClassId = CharacterClass.Paladin, Hp = 150, User = u },
      new CharacterEntity() { Id = 1002, PositionX = 6, PositionY = 6, LevelValue = 1, ClassId = CharacterClass.Rogue, Hp = 120, User = u },
       // To attack not in range
      new CharacterEntity() { Id = 1003, PositionX = 5, PositionY = 5, LevelValue = 1, ClassId = CharacterClass.Rogue, Hp = 150, User = u },
      new CharacterEntity() { Id = 1004, PositionX = 300, PositionY = 300, LevelValue = 1, ClassId = CharacterClass.Wizard, Hp = 120, User = u },
       //Alive
      new CharacterEntity() { Id = 2001, PositionX = 300, PositionY = 300, LevelValue = 1, ClassId = CharacterClass.Rogue, User = u, Hp = 120 },
       // Dead
      new CharacterEntity() { Id = 2002, PositionX = 300, PositionY = 300, LevelValue = 1, ClassId = CharacterClass.Rogue, User = u, Hp = 0 },
